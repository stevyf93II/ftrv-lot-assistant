...
const BOOL_FILTER_FIELDS = ['dishwasher','central_vacuum','off_grid_solar','wd_installed','murphy_bed','kit_island','outdoor_kitchen','auto_level','solar_pkg','walkin_shower','bunkroom','hideabed','on_demand_water','convection_oven','kit_pantry','kit_residential_fridge','power_awning','outdoor_tv','ceiling_fan','pullout_pantry','wd_prep_only','walkin_closet','theater_seat','desk','bunk_private_door','l_shaped_sofa','u_shaped_dinette','jackknife_sofa','electric_tilt_bed'];
